classdef agent_bot
    ...
    properties
        ...
        isleader; % if zero, means that the agent is a leader bot else follower
        isspiral;  % if 1, means its in a spiral, else zero
        spiral_theta; % The angle which tells at what angle it is in the spiral
        radius;  % present radius during spiral
